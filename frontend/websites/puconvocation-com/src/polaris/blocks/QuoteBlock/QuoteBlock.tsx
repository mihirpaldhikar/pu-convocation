...
import { type ChangeEvent, createElement, type JSX, useContext, useEffect, useRef } from "react";
import {
...
import { type BlockLifecycle, type BlockSchema, type Table } from "../../interfaces";
...
export default function QuoteBlock({
  ...
  return createElement("blockquote", {
    ...
    style: {
      fontSize: `${config.block.text.quote.fontSize}rem`,
      fontWeight: config.block.text.quote.fontWeight,
      lineHeight: config.block.text.quote.lineHeight,
      ...setNodeStyle(block.style),
    },
    placeholder: "Write your quote...",
    spellCheck: true,
    className: conditionalClassName(
      "text_renderer block border-l-[6px] px-5 py-3 flex-1 overflow-hidden focus:outline-none focus:ring-0 outline-none ring-0 cursor-text border-gray-300 bg-gray-100 break-words",
    ),
