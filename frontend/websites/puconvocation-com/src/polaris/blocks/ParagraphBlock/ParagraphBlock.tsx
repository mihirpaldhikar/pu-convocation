...
export default function ParagraphBlock({
  block,
  blockLifecycle,
}: ParagraphBlockProps): JSX.Element {
  const {
    previousParentBlock,
    editable,
    listMetadata,
  ...
  return createElement("p", {
    ...
    style: {
      fontSize: `${config.block.text.paragraph.fontSize}rem`,
      fontWeight: config.block.text.paragraph.fontWeight,
      lineHeight: config.block.text.paragraph.lineHeight,
